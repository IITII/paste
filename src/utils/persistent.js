...
const pasteGet = (key, storage = localStorage) => getI(prefix.paste + key, storage)
//set
...
const pasteSet = (key, value, storage = localStorage) => setI(prefix.paste + key, value, storage)
//remove
...
const pasteRemove = (key, storage = localStorage) => removeI(prefix.paste + key, storage)
